...
mod tests {
    ...
    fn test_get_count() {
        let expectations = [
            ...
            SpiTransaction::transfer(
                ...
                vec![0x00, 0x00, 0x00, 0x00, 0b00001010],
            ),
            SpiTransaction::transfer(
                vec![
                    InstructionRegister {
            ...
            SpiTransaction::transfer(
                ...
                vec![0x00, 0x00, 0x00, 0x00, 0b00001011],
            ),
        ];
    ...
    fn test_status_a() {
        let expectations = [
            ...
            SpiTransaction::transfer(
                ...
                vec![0x00, 0x00, 0x00, 0x00, 0b11110101],
            ),
        ];
    ...
    fn test_status_b() {
        let expectations = [
            ...
            SpiTransaction::transfer(
                ...
                vec![0x00, 0x00, 0x00, 0x00, 0b00000100],
            ),
        ];
        let spi = Mock::new(&expectations);
        let mut driver = Ls7366::new_uninit(spi);
    ...
    fn test_write_register() {
        ...
        driver
            .write_register(Target::Dtr, &vec![0xBA, 0xAD, 0xBE, 0xEF])
            .unwrap();
        driver
            .write_register(Target::Mdr0, &vec![0xFD, 0xFD, 0xFD, 0xFD])
            .unwrap();
    }
}
